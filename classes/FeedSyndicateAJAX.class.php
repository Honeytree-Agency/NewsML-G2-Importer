...
class FeedSyndicateAJAX {
    ...
    private function security() {
        switch (filter_input(INPUT_POST, "type")) {
            ...
            case "Edit_feed_handler":
                $this->verify_nonce();
                break;
            case "account_key_handler":
                $this->verify_nonce();
                break;
            case "auto_update_feed_handler":
                $this->verify_data();
                break;
            case "dismiss_welcome_notice_handler":
                break;
        }
    }
	...
	/**
	 * Allows Permanent Welcome Notice Dismissal
	 * @return void
	 */
	public function dismiss_welcome_notice_handler() {

		update_option( "FeedSyndicateWelcomeNotice", 'hide' );
	 ...
	 * @return void
	 */
	public function account_key_handler() {

		$key = filter_input(INPUT_POST, "key");

		if ( ! empty( $key ) ) {
			update_option( "FeedSyndicateAccountKey", $key );
		}
